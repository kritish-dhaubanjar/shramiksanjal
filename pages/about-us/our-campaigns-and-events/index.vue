                ...
                >
                  <div class="row">
                    ...
                    >
                      <div>
                        <div
                          class="background-image rounded-circle"
                          :style="
                    ...
                    <div class="col-sm d-flex align-items-center">
                      <nuxt-link
                        ...
                        :to="
                          localePath(
                            `/about-us/our-campaigns-and-events/${event._id}`
                          )
                        "
...
export default {
  head() {
    return {
      title: `Shramiksanjal :: Our Campaigns & Events`,
      meta: [
        {
          hid: "description",
          name: "description",
  ...
  computed: {
    slice() {
      ...
      return this.events.slice(
        perpage * (this.range.current - 1),
        perpage * this.range.current
      );
    }
  },
